...
grid.arrange(p1, p2, p3, layout_matrix = lay, widths= c(4,4,1,10,1,4), heights= c(14,1))

    png(file=paste0("test", ".png"), res=325, width=2500, height = 1750) 
    grid.arrange(p1, p2, p3, layout_matrix = lay, widths= c(4,4,1,10,1,4), heights= c(14,1))
    dev.off()
    
 # grid.arrange(p1, grid.arrange(
 #              p2, n, p3, n, n, n, nrow = 2, ncol= heights = c(3, 1)),
 #              nrow = 1, ncol=2, widths = c(1,1))
 
# ggarrange(p1, NULL, 
#             ggarrange(p2, NULL, p3, NULL, NULL, NULL,
#             ncol = 3, nrow = 2, 
#             widths = c(4, 1, 4), heights = c(4,1)),
...
genes <- c("Aif1", "Gfap", "Sv2b", "Aqp4", "Lpl")
